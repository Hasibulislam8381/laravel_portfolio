                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-center">Active Banner 2</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td_btn">
                                                        ...
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#myModal"
                                                            onclick="updatedata('{{ $banner->id }}','{{ $banner->title }}','{{ $banner->description }}','{{ $banner->alt_text }}')"
                                                            class="btn btn-sm btn-info">Edit</a>
                                                        <a href="{{ route('backend.banner2.status', $banner->id) }}"
                                                            class=" btn {{ $banner->status == 'publish' ? 'btn btn-warning' : 'btn btn-success' }}">{{ $banner->status == 'publish' ? 'Draft' : 'Publish' }}</a>
                                                        <a href="{{ route('backend.banner2.trash', $banner->id) }}"
                                        ...
                                        <tbody class="table">
                                            ...
                                            @foreach ($trashedBanners as $banner)
                                                <tr>
                                                    ...
                                                    <td>{{ $banner->alt_text }}</td>
                                                    <td class="td_btn">
                                                        <a href="{{ route('backend.banner2.reStore', $banner->id) }}"
                                                            class="btn btn-sm btn-success">Restore</a>

                                                        <form action="{{ route('backend.banner2.delete', $banner->id) }}"
...
@endsection
<script>
    function updatedata(id,title,  description, alt_text) {
        $("#id").val(id);
        $("#title").val(title);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('backend.banner2.update', $banner->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class=" form-group">
                        <b>Photo(1200x500):</b>
                        <input type="file" name="photo" id="photo" class=" form-control">
                        <img src="{{ $banner->photo }}" width="60" alt="{{ $banner->photo }}">
                    </div>
